...
def main(args):
    ...
    train_loader, test_loader, train_sampler = datapool(
        ...
        autoaug=args.autoaug, cutout=args.cutout, distributed=False, cache_dataset=False)


    # ## model = spiking_vgg.__dict__[args.model](single_step_neuron=neuron.OnlineLIFNode, tau=args.tau, surrogate_function=surrogate.QuasiClamp(alpha=1.), track_rate=True, c_in=3, num_classes=num_classes, neuron_dropout=args.drop_rate, grad_with_rate=True, fc_hw=1, v_reset=None)
